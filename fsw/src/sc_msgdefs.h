...
#define SC_FAILED_DISTRIB \
    7                 /**< \brief the object could not be sent on the SWB */
...
/** \{ */
#define SC_NUMBER_OF_ATS                                \
    2 /**< \brief the number of Absolute Time Sequences \
       */
/** \} */
...
**       This command may fail for the following reason(s):
**       - Command packet length not as expected
**       - Invalid group definition, first RTS ID must be 1 through
*#SC_NUMBER_OF_RTS
**       - Invalid group definition, last RTS ID must be 1 through
*#SC_NUMBER_OF_RTS
**       - Invalid group definition, last RTS ID must be greater than or equal
*to first RTS ID
**       - If the group definition is valid the command will report success,
*regardless of
**         whether any RTS in the group is actually STARTED by the command.
**
**  \par Evidence of failure may be found in the following telemetry:
**       - \b \c \SC_CMDEC - command error counter will increment
**       - The #SC_LEN_ERR_EID event will indicate invalid command packet
*length.
**       - The #SC_STARTRTSGRP_CMD_ERR_EID event will indicate invalid group
*definition.
**
**  \par Criticality
**       None
...
**       The enable state for an RTS may be ENABLED or DISABLED.
**       The run state for an RTS may be STARTED or STOPPED.
**       This command STOPS each RTS in the specified group that is currently
*STARTED.
**
...
**       - The #SC_LEN_ERR_EID event will indicate invalid command packet
*length.
**       - The #SC_STOPRTSGRP_CMD_ERR_EID event will indicate invalid group
*definition.
**
**  \par Criticality
**       None
...
**  \par Description
**       The enable state for an RTS may be ENABLED or DISABLED.
**       This command sets the enable state for the specified group of RTS to
*DISABLED.
**
...
**         in the group that were changed from ENABLED to DISABLED by the
*command
**
**  \par Error Conditions
**       This command may fail for the following reason(s):
...
**       - The #SC_LEN_ERR_EID event will indicate invalid command packet
*length.
**       - The #SC_DISRTSGRP_CMD_ERR_EID event will indicate invalid group
*definition.
**
**  \par Criticality
**       None
...
**       the following telemetry:
**       - \b \c \SC_CMDPC       - command counter will increment
**       - The #SC_ENARTSGRP_CMD_INF_EID event will indicate success and display
*the
**         number of RTS that were changed from DISABLED to ENABLED by the
*command.
**
**  \par Error Conditions
**       This command may fail for the following reason(s):
...
**       - The #SC_LEN_ERR_EID event will indicate invalid command packet
*length.
**       - The #SC_ENARTSGRP_CMD_ERR_EID event will indicate invalid group
*definition.
**
**  \par Criticality
**       None
