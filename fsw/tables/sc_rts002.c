...
** Member renamed from sc_rts2.c to sc_rts002.c in project
...
static CFE_TBL_FileDef_t CFE_TBL_FileDef __attribute__((__used__)) = {
    "RTS_Table002", "SC.RTS_TBL002", "SC Sample RTS_TBL002", "sc_rts002.tbl",
...
uint16 RTS_Table002[SC_RTS_BUFF_SIZE] = {
    ...
    ((SC_NOOP_CC << 8) | CMD2_XSUM),
    CMD3_TIME,
    CFE_MAKE_BIG16(SC_CMD_MID),
    CFE_MAKE_BIG16(PKT_FLAGS),
    CFE_MAKE_BIG16(CMD3_LENGTH),
    ((SC_NOOP_CC << 8) | CMD3_XSUM)};
