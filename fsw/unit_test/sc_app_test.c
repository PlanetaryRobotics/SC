...
**
** Purpose:
**   This file contains unit test cases for the for the functions contained in
*the file sc_app.c.
**
** References:
...
void SC_AppMain_Test_Nominal(void) {
    ...
    CFE_SB_InitMsg(&SC_OperData.MsgPtr, SC_CMD_MID, sizeof(SC_NoArgsCmd_t),
                   TRUE);
...
void SC_AppMain_Test_RegisterAppError(void) {
    /* Set CFE_ES_RegisterApp to return -1 in order to reach "Result =
     * SC_AppInit()" */
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(SC_APP_EXIT_ERR_EID, CFE_EVS_ERROR,
...
void SC_AppMain_Test_AppInitError(void) {
    /* Set CFE_EVS_Register to return -1 in order to make SC_AppInit return -1,
     * in order to reach "RunStatus = CFE_ES_APP_ERROR" */
...
void SC_AppMain_Test_RcvMsgError(void) {
    /* Set CFE_SB_RcvMsg to return -1 in order to reach "RunStatus =
     * CFE_ES_APP_ERROR" */
...
void SC_AppInit_Test_NominalPowerOnReset(void) {
    ...
    /* Set CFE_ES_GetResetType to return CFE_ES_POWERON_RESET in order to reach
    ...
    /* Set global data structures to non-zero values, to verify that SC_AppInit
     * sets values to 0 (with some exceptions)  */
    ...
    CFE_SB_InitMsg(&Expected_SC_OperData.HkPacket, SC_HK_TLM_MID,
                   sizeof(SC_HkTlm_t), FALSE);
    ...
    UtAssert_MemCmp(&SC_AppData, &Expected_SC_AppData, sizeof(SC_AppData_t),
                    "SC_AppData == Expected_SC_AppData");
    ...
    UtAssert_MemCmp(&SC_OperData.MsgPtr, &Expected_SC_OperData.MsgPtr,
                    sizeof(Expected_SC_OperData.MsgPtr), "1");
    UtAssert_MemCmp(&SC_OperData.CmdPipe, &Expected_SC_OperData.CmdPipe,
                    sizeof(Expected_SC_OperData.CmdPipe), "2");
    UtAssert_MemCmp(&SC_OperData.AtsTblAddr, &Expected_SC_OperData.AtsTblAddr,
                    sizeof(Expected_SC_OperData.AtsTblAddr), "4");
    UtAssert_MemCmp(&SC_OperData.AppendTblAddr,
                    &Expected_SC_OperData.AppendTblAddr,
                    sizeof(Expected_SC_OperData.AppendTblAddr), "6");
    UtAssert_MemCmp(&SC_OperData.RtsTblAddr, &Expected_SC_OperData.RtsTblAddr,
                    sizeof(Expected_SC_OperData.RtsTblAddr), "8");
    UtAssert_MemCmp(
        &SC_OperData.AtsInfoHandle, &Expected_SC_OperData.AtsInfoHandle,
        sizeof(Expected_SC_OperData.AtsInfoHandle), "AtsInfoHandle");
    UtAssert_MemCmp(
        &SC_OperData.AppendInfoHandle, &Expected_SC_OperData.AppendInfoHandle,
    ...
    UtAssert_MemCmp(
        &SC_OperData.RtsCtrlBlckHandle, &Expected_SC_OperData.RtsCtrlBlckHandle,
        sizeof(Expected_SC_OperData.RtsCtrlBlckHandle), "RtsCtrlBlckHandle");
    UtAssert_MemCmp(
        &SC_OperData.AtsCtrlBlckHandle, &Expected_SC_OperData.AtsCtrlBlckHandle,
    ...
    UtAssert_MemCmp(&SC_OperData.NumCmdsSec, &Expected_SC_OperData.NumCmdsSec,
                    sizeof(Expected_SC_OperData.NumCmdsSec), "22");
    UtAssert_MemCmp(&SC_OperData.HkPacket, &Expected_SC_OperData.HkPacket,
                    sizeof(Expected_SC_OperData.HkPacket), "23");

    sprintf(Message, "SC Initialized. Version %d.%d.%d.%d", SC_MAJOR_VERSION,
            SC_MINOR_VERSION, SC_REVISION, SC_MISSION_REV);
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_INIT_INF_EID, CFE_EVS_INFORMATION, Message),
        Message);
...
void SC_AppInit_Test_Nominal(void) {
    ...
    /* Set CFE_ES_GetResetType to return something other than
     * CFE_ES_POWERON_RESET in order to reach "SC_AppData.AutoStartRTS =
     * RTS_ID_AUTO_PROCESSOR" */
...
void SC_AppInit_Test_EVSRegisterError(void) {
    ...
    /* Set CFE_EVS_Register to return -1 in order to reach
...
void SC_AppInit_Test_SBCreatePipeError(void) {
    ...
    /* Set CFE_SB_CreatePipe to return -1 in order to generate error message
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_INIT_SB_CREATE_ERR_EID, CFE_EVS_ERROR,
...
void SC_AppInit_Test_SBSubscribeHKError(void) {
    /**
     **  Test case: "Software Bus subscribe to housekeeping returned: 0x%08X",
     *Result
     **/

    int32 ReturnValue;

    /* Set CFE_SB_Subscribe to return -1 on the first call in order to generate
     * error message SC_INIT_SB_SUBSCRIBE_HK_ERR_EID */
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_INIT_SB_SUBSCRIBE_HK_ERR_EID, CFE_EVS_ERROR,
...
void SC_AppInit_Test_SubscribeTo1HzError(void) {
    /**
     **  Test case: "Software Bus subscribe to 1 Hz cycle returned: 0x%08X",
     *Result
     **/

    int32 ReturnValue;

    /* Set CFE_SB_Subscribe to return -1 on the 2nd call in order to generate
     * error message SC_INIT_SB_SUBSCRIBE_1HZ_ERR_EID */
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_INIT_SB_SUBSCRIBE_1HZ_ERR_EID, CFE_EVS_ERROR,
...
void SC_AppInit_Test_SBSubscribeToCmdError(void) {
    ...
    /* Set CFE_SB_Subscribe to return -1 on the 3rd call in order to generate
     * error message SC_INIT_SB_SUBSCRIBE_CMD_ERR_EID */
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      SC_INIT_SB_SUBSCRIBE_CMD_ERR_EID, CFE_EVS_ERROR,
...
void SC_AppInit_Test_InitTablesError(void) {
    ...
    /* Set CFE_TBL_Register to return -1 in order to reach return statement
     * immediately after
...
void SC_InitTables_Test_ErrorRegisterAllTables(void) {
    ...
    /* Set CFE_TBL_Register to return -1 in order to cause SC_RegisterAllTables
     * to return -1, in order to reach "return(Result)" after
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      SC_REGISTER_RTS_INFO_TABLE_ERR_EID, CFE_EVS_ERROR,
...
void SC_InitTables_Test_ErrorGetDumpTablePointers(void) {
    ...
    /* Set CFE_TBL_GetAddress to return -1 in order to cause
     * SC_GetDumpTablePointers to return -1, in order to reach
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_GET_ADDRESS_RTS_INFO_ERR_EID, CFE_EVS_ERROR,
...
void SC_InitTables_Test_ErrorGetLoadTablePointers(void) {
    ...
    /* Causes SC_GetLoadTablePointers to return -1 in order to cause
     * SC_GetLoadTablePointers to return -1, in order to reach
     * "Return(Result)" after SC_GetLoadTablePointers */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_GETADDRESS_INDEX, -1,
                             SC_NUMBER_OF_ATS + 6);
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_GET_ADDRESS_ATS_ERR_EID, CFE_EVS_ERROR,
...
void SC_RegisterAllTables_Test_ErrorRegisterRTSInformation(void) {
    ...
    /* Set CFE_TBL_Register to return -1 on the 1st call in order to generate
     * error message SC_REGISTER_RTS_INFO_TABLE_ERR_EID */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_REGISTER_INDEX, -1, 1);
...
void SC_RegisterAllTables_Test_ErrorRegisterRTPControl(void) {
    ...
    /* Set CFE_TBL_Register to return -1 on the 2nd call in order to generate
     * error message SC_REGISTER_RTS_CTRL_BLK_TABLE_ERR_EID */
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_REGISTER_RTS_CTRL_BLK_TABLE_ERR_EID, CFE_EVS_ERROR,
...
void SC_RegisterAllTables_Test_ErrorRegisterATSInformation(void) {
    ...
    /* Set CFE_TBL_Register to return -1 on the 3rd call in order to generate
     * error message SC_REGISTER_ATS_INFO_TABLE_ERR_EID */
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      SC_REGISTER_ATS_INFO_TABLE_ERR_EID, CFE_EVS_ERROR,
...
void SC_RegisterAllTables_Test_ErrorRegisterAppendATSInformation(void) {
    ...
    /* Set CFE_TBL_Register to return -1 on the 4th call in order to generate
     * error message SC_REGISTER_APPEND_INFO_TABLE_ERR_EID */
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_REGISTER_APPEND_INFO_TABLE_ERR_EID, CFE_EVS_ERROR,
...
void SC_RegisterAllTables_Test_ErrorRegisterATPControl(void) {
    ...
    /* Set CFE_TBL_Register to return -1 on the 5th call in order to generate
     * error message SC_REGISTER_ATS_CTRL_BLK_TABLE_ERR_EID */
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_REGISTER_ATS_CTRL_BLK_TABLE_ERR_EID, CFE_EVS_ERROR,
...
void SC_RegisterAllTables_Test_ErrorRegisterATSCommandStatus(void) {
    ...
    /* Set CFE_TBL_Register to return -1 on the 6th call in order to generate
     * error message SC_REGISTER_ATS_CMD_STATUS_TABLE_ERR_EID */
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      SC_REGISTER_ATS_CMD_STATUS_TABLE_ERR_EID, CFE_EVS_ERROR,
                      "ATS command status table register failed for ATS 1, "
                      "returned: 0xFFFFFFFF"),
                  "ATS command status table register failed for ATS 1, "
                  "returned: 0xFFFFFFFF");
    UtAssert_True(ReturnValue == -1, "ReturnValue == -1");
...
void SC_RegisterAllTables_Test_ErrorRegisterLoadableRTS(void) {
    ...
    /* Set CFE_TBL_Register to return -1 on the last call when registering
     * loadable RTS tables in order to generate error message
     * SC_REGISTER_RTS_TBL_ERR_EID */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_REGISTER_INDEX, -1,
                             6 + SC_NUMBER_OF_ATS);
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_REGISTER_RTS_TBL_ERR_EID, CFE_EVS_ERROR,
...
void SC_RegisterAllTables_Test_ErrorRegisterLoadableATS(void) {
    ...
    /* Set CFE_TBL_Register to return -1 on the last call when registering
     * loadable ATS tables in order to generate error message
     * SC_REGISTER_ATS_TBL_ERR_EID */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_REGISTER_INDEX, -1,
                             6 + SC_NUMBER_OF_ATS + SC_NUMBER_OF_RTS);
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_REGISTER_ATS_TBL_ERR_EID, CFE_EVS_ERROR,
...
void SC_RegisterAllTables_Test_ErrorRegisterLoadableAppendATS(void) {
    ...
    /* Set CFE_TBL_Register to return -1 on the last call when registering
     * loadable Append ATS tables in order to generate error message
     * SC_REGISTER_APPEND_TBL_ERR_EID */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_REGISTER_INDEX, -1,
                             6 + 2 * SC_NUMBER_OF_ATS + SC_NUMBER_OF_RTS);
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_REGISTER_APPEND_TBL_ERR_EID, CFE_EVS_ERROR,
...
void SC_GetDumpTablePointers_Test_ErrorGetAddressRTSInformation(void) {
    ...
    /* Need to set CFE_TBL_GetAddress to return -1 on 1st call (to generate
     * error message SC_GET_ADDRESS_RTS_INFO_ERR_EID) and CFE_SUCCESS on all
     * other calls.  This could have been done using just a hook function and a
     * global variable, but it was simpler to set a hook function that just
     * returns CFE_SUCCESS and then also set a return code for the particular
     * call number.  Because of the order of handling of return values and hook
     * functions in the stub function, this results in the return code being
     * used if it's the right call number, while otherwise using the hook
     * function. */
    Ut_CFE_TBL_SetFunctionHook(UT_CFE_TBL_GETADDRESS_INDEX,
                               &CFE_TBL_GetAddressHookNominal);
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_GETADDRESS_INDEX, -1, 1);
...
void SC_GetDumpTablePointers_Test_ErrorGetAddressRTPControl(void) {
    ...
    /* Need to set CFE_TBL_GetAddress to return -1 on 2nd call (to generate
     * error message SC_GET_ADDRESS_RTS_CTRL_BLCK_ERR_EID) and CFE_SUCCESS on
     * all other calls.  This could have been done using just a hook function
     * and a global variable, but it was simpler to set a hook function that
     * just returns CFE_SUCCESS and then also set a return code for the
     * particular call number.  Because of the order of handling of return
     * values and hook functions in the stub function, this results in the
     * return code being used if it's the right call number, while otherwise
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_GET_ADDRESS_RTS_CTRL_BLCK_ERR_EID, CFE_EVS_ERROR,
...
void SC_GetDumpTablePointers_Test_ErrorGetAddressATSInformation(void) {
    ...
    /* Need to set CFE_TBL_GetAddress to return -1 on 3rd call (to generate
     * error message SC_GET_ADDRESS_ATS_INFO_ERR_EID) and CFE_SUCCESS on all
     * other calls.  This could have been done using just a hook function and a
     * global variable, but it was simpler to set a hook function that just
     * returns CFE_SUCCESS and then also set a return code for the particular
     * call number.  Because of the order of handling of return values and hook
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_GET_ADDRESS_ATS_INFO_ERR_EID, CFE_EVS_ERROR,
...
void SC_GetDumpTablePointers_Test_ErrorGetAddressAppendATSInformation(void) {
    ...
    /* Need to set CFE_TBL_GetAddress to return -1 on 4th call (to generate
     * error message SC_GET_ADDRESS_APPEND_INFO_ERR_EID) and CFE_SUCCESS on all
     * other calls.  This could have been done using just a hook function and a
     * global variable, but it was simpler to set a hook function that just
     * returns CFE_SUCCESS and then also set a return code for the particular
     * call number.  Because of the order of handling of return values and hook
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_GET_ADDRESS_APPEND_INFO_ERR_EID, CFE_EVS_ERROR,
                             "Append ATS Info table failed Getting Address, "
                             "returned: 0xFFFFFFFF"),
...
void SC_GetDumpTablePointers_Test_ErrorGetAddressATPControl(void) {
    ...
    /* Need to set CFE_TBL_GetAddress to return -1 on 5th call (to generate
     * error message SC_GET_ADDRESS_ATS_CTRL_BLCK_ERR_EID) and CFE_SUCCESS on
     * all other calls.  This could have been done using just a hook function
     * and a global variable, but it was simpler to set a hook function that
     * just returns CFE_SUCCESS and then also set a return code for the
     * particular call number.  Because of the order of handling of return
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_GET_ADDRESS_ATS_CTRL_BLCK_ERR_EID, CFE_EVS_ERROR,
...
void SC_GetDumpTablePointers_Test_ErrorGetAddressATSCommandStatus(void) {
    ...
    /* Need to set CFE_TBL_GetAddress to return -1 on 6th call (to generate
     * error message SC_GET_ADDRESS_ATS_CMD_STAT_ERR_EID) and CFE_SUCCESS on all
     * other calls.  This could have been done using just a hook function and a
     * global variable, but it was simpler to set a hook function that just
     * returns CFE_SUCCESS and then also set a return code for the particular
     * call number.  Because of the order of handling of return values and hook
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_GET_ADDRESS_ATS_CMD_STAT_ERR_EID, CFE_EVS_ERROR,
                             "ATS Cmd Status table for ATS 1 failed Getting "
                             "Address, returned: 0xFFFFFFFF"),
        "ATS Cmd Status table for ATS 1 failed Getting Address, returned: "
        "0xFFFFFFFF");
    UtAssert_True(ReturnValue == -1, "ReturnValue == -1");
    UtAssert_True(Ut_CFE_EVS_GetEventQueueDepth() == 1,
                  "Ut_CFE_EVS_GetEventQueueDepth() == 1");
...
void SC_GetLoadTablePointers_Test_ErrorGetAddressLoadableATS(void) {
    ...
    /* Need to set CFE_TBL_GetAddress to return -1 on 1st call (to generate
     * error message SC_GET_ADDRESS_ATS_ERR_EID) and CFE_TBL_ERR_NEVER_LOADED on
     * all other calls.  This could have been done using just a hook function
     * and a global variable, but it was simpler to set a hook function that
     * just returns CFE_SUCCESS and then also set a return code for the
     * particular call number.  Because of the order of handling of return
     ...
     * using the hook function. */
    Ut_CFE_TBL_SetFunctionHook(UT_CFE_TBL_GETADDRESS_INDEX,
                               &CFE_TBL_GetAddressHookNominal2);
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_GETADDRESS_INDEX, -1, 1);
...
void SC_GetLoadTablePointers_Test_ErrorGetAddressLoadableATSAppend(void) {
    ...
    /* Need to set CFE_TBL_GetAddress to return -1 on call (SC_NUMBER_OF_ATS +
     * 1) (to generate error message SC_GET_ADDRESS_APPEND_ERR_EID) and
     * CFE_TBL_ERR_NEVER_LOADED on all other calls.  This could have been done
     * using just a hook function and a global variable, but it was simpler to
     * set a hook function that just returns CFE_SUCCESS and then also set a
     * return code for the particular call number.  Because of the order of
     * handling of return values and hook functions in the stub function, this
     * results in the return code being used if it's the right call number,
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_GET_ADDRESS_APPEND_ERR_EID, CFE_EVS_ERROR,
...
void SC_GetLoadTablePointers_Test_ErrorGetAddressLoadableRTS(void) {
    ...
    /* Need to set CFE_TBL_GetAddress to return -1 on call (SC_NUMBER_OF_ATS +
     * 2) (to generate error message SC_GET_ADDRESS_RTS_ERR_EID) and
     * CFE_TBL_ERR_NEVER_LOADED on all other calls.  This could have been done
     * using just a hook function and a global variable, but it was simpler to
     * set a hook function that just returns CFE_SUCCESS and then also set a
     * return code for the particular call number.  Because of the order of
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_GET_ADDRESS_RTS_ERR_EID, CFE_EVS_ERROR,
...
void SC_LoadDefaultTables_Test(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_RTS_LOAD_COUNT_INFO_EID, CFE_EVS_INFORMATION,
...
void SC_App_Test_AddTestCases(void) {
    UtTest_Add(SC_AppMain_Test_Nominal, SC_Test_Setup, SC_Test_TearDown,
               "SC_AppMain_Test_Nominal");
    UtTest_Add(SC_AppMain_Test_RegisterAppError, SC_Test_Setup,
               SC_Test_TearDown, "SC_AppMain_Test_RegisterAppError");
    UtTest_Add(SC_AppMain_Test_AppInitError, SC_Test_Setup, SC_Test_TearDown,
               "SC_AppMain_Test_AppInitError");
    UtTest_Add(SC_AppMain_Test_RcvMsgError, SC_Test_Setup, SC_Test_TearDown,
               "SC_AppMain_Test_RcvMsgError");
    UtTest_Add(SC_AppInit_Test_NominalPowerOnReset, SC_Test_Setup,
               SC_Test_TearDown, "SC_AppInit_Test_NominalPowerOnReset");
    UtTest_Add(SC_AppInit_Test_Nominal, SC_Test_Setup, SC_Test_TearDown,
               "SC_AppInit_Test_Nominal");
    UtTest_Add(SC_AppInit_Test_EVSRegisterError, SC_Test_Setup,
               SC_Test_TearDown, "SC_AppInit_Test_EVSRegisterError");
    UtTest_Add(SC_AppInit_Test_SBCreatePipeError, SC_Test_Setup,
               SC_Test_TearDown, "SC_AppInit_Test_SBCreatePipeError");
    UtTest_Add(SC_AppInit_Test_SBSubscribeHKError, SC_Test_Setup,
               SC_Test_TearDown, "SC_AppInit_Test_SBSubscribeHKError");
    UtTest_Add(SC_AppInit_Test_SBSubscribeToCmdError, SC_Test_Setup,
               SC_Test_TearDown, "SC_AppInit_Test_SBSubscribeToCmdError");
    UtTest_Add(SC_AppInit_Test_SubscribeTo1HzError, SC_Test_Setup,
               SC_Test_TearDown, "SC_AppInit_Test_SubscribeTo1HzError");
    UtTest_Add(SC_AppInit_Test_InitTablesError, SC_Test_Setup, SC_Test_TearDown,
               "SC_AppInit_Test_InitTablesError");
    UtTest_Add(SC_InitTables_Test_Nominal, SC_Test_Setup, SC_Test_TearDown,
               "SC_InitTables_Test_Nominal");
    UtTest_Add(SC_InitTables_Test_ErrorRegisterAllTables, SC_Test_Setup,
               SC_Test_TearDown, "SC_InitTables_Test_ErrorRegisterAllTables");
    UtTest_Add(SC_InitTables_Test_ErrorGetDumpTablePointers, SC_Test_Setup,
               SC_Test_TearDown,
               "SC_InitTables_Test_ErrorGetDumpTablePointers");
    UtTest_Add(SC_InitTables_Test_ErrorGetLoadTablePointers, SC_Test_Setup,
               SC_Test_TearDown,
               "SC_InitTables_Test_ErrorGetLoadTablePointers");
    UtTest_Add(SC_RegisterAllTables_Test_Nominal, SC_Test_Setup,
               SC_Test_TearDown, "SC_RegisterAllTables_Test_Nominal");
    ...
    UtTest_Add(SC_RegisterAllTables_Test_ErrorRegisterRTPControl, SC_Test_Setup,
               SC_Test_TearDown,
    ...
    UtTest_Add(SC_RegisterAllTables_Test_ErrorRegisterAppendATSInformation,
               SC_Test_Setup, SC_Test_TearDown,
    ...
    UtTest_Add(SC_GetDumpTablePointers_Test_Nominal, SC_Test_Setup,
               SC_Test_TearDown, "SC_GetDumpTablePointers_Test_Nominal");
    ...
    UtTest_Add(SC_LoadDefaultTables_Test, SC_Test_Setup, SC_Test_TearDown,
               "SC_LoadDefaultTables_Test");
