...
CFE_TIME_Compare_t UT_SC_StartAtsRq_CompareHookAgreaterthanB(
...
CFE_TIME_Compare_t UT_SC_StartAtsRq_CompareHook3(CFE_TIME_SysTime_t TimeA,
...
void SC_StartAtsCmd_Test_Nominal(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_STARTATS_CMD_INF_EID, CFE_EVS_INFORMATION,
...
void SC_StartAtsCmd_Test_CouldNotStart(void) {
    ...
    Ut_CFE_TIME_SetFunctionHook(UT_CFE_TIME_COMPARE_INDEX,
                                &UT_SC_StartAtsRq_CompareHookAgreaterthanB);
    ...
    Ut_CFE_PSP_MEMUTILS_SetReturnCode(UT_CFE_PSP_MEMUTILS_MEMCPY_INDEX,
                                      CFE_PSP_SUCCESS, 1);
    Ut_CFE_PSP_MEMUTILS_ContinueReturnCodeAfterCountZero(
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_ATS_SKP_ALL_ERR_EID, CFE_EVS_ERROR,
...
void SC_StartAtsCmd_Test_NoCommands(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_STARTATS_CMD_NOT_LDED_ERR_EID, CFE_EVS_ERROR,
...
void SC_StartAtsCmd_Test_InUse(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_STARTATS_CMD_NOT_IDLE_ERR_EID, CFE_EVS_ERROR,
...
void SC_StartAtsCmd_Test_InvalidAtsId(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_STARTATS_CMD_INVLD_ID_ERR_EID, CFE_EVS_ERROR,
...
void SC_StopAtsCmd_Test_NominalA(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(SC_STOPATS_CMD_INF_EID,
                                       CFE_EVS_INFORMATION, "ATS A stopped"),
                  "ATS A stopped");
...
void SC_StopAtsCmd_Test_NominalB(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(SC_STOPATS_CMD_INF_EID,
                                       CFE_EVS_INFORMATION, "ATS B stopped"),
                  "ATS B stopped");
...
void SC_StopAtsCmd_Test_NoRunningAts(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_STOPATS_NO_ATS_INF_EID, CFE_EVS_INFORMATION,
...
void SC_BeginAts_Test_Nominal(void) {
    ...
    UtAssert_True(SC_OperData.AtsCtrlBlckAddr->AtsNumber == 1,
                  "SC_OperData.AtsCtrlBlckAddr->AtsNumber == 1");
    UtAssert_True(SC_OperData.AtsCtrlBlckAddr->CmdNumber ==
                      SC_AppData.AtsTimeIndexBuffer[AtsIndex][0],
                  "SC_OperData.AtsCtrlBlckAddr->CmdNumber == "
                  "SC_AppData.AtsTimeIndexBuffer[AtsIndex][0]");
    UtAssert_True(SC_OperData.AtsCtrlBlckAddr->TimeIndexPtr == 0,
                  "SC_OperData.AtsCtrlBlckAddr->TimeIndexPtr == 0");
    UtAssert_True(SC_AppData.NextCmdTime[SC_ATP] == 0,
                  "SC_AppData.NextCmdTime[SC_ATP] == 0");

    UtAssert_True(Ut_CFE_EVS_EventSent(SC_ATS_ERR_SKP_DBG_EID, CFE_EVS_DEBUG,
...
void SC_BeginAts_Test_AllCommandsSkipped(void) {
    ...
    /* Set to cause all commnds to be skipped, to generate error message
...
void SC_KillAts_Test(void) {
    ...
    /* Verify results */
    UtAssert_True(SC_OperData.AtsInfoTblAddr[0].AtsUseCtr == 1,
                  "SC_OperData.AtsInfoTblAddr[0].AtsUseCtr == 1");
    UtAssert_True(SC_OperData.AtsCtrlBlckAddr->AtpState == SC_IDLE,
                  "SC_OperData.AtsCtrlBlckAddr->AtpState == SC_IDLE");
    UtAssert_True(SC_AppData.NextCmdTime[SC_ATP] == SC_MAX_TIME,
...
void SC_GroundSwitchCmd_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_SWITCH_ATS_CMD_INF_EID, CFE_EVS_INFORMATION,
...
void SC_GroundSwitchCmd_Test_DestinationAtsNotLoaded(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_SWITCH_ATS_CMD_NOT_LDED_ERR_EID, CFE_EVS_ERROR,
...
void SC_GroundSwitchCmd_Test_AtpIdle(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_SWITCH_ATS_CMD_IDLE_ERR_EID, CFE_EVS_ERROR,
...
void SC_ServiceSwitchPend_Test_Nominal(void) {
    ...
    /* Set to satisfy first if-statement, while not affecting later calls to
     * CFE_TIME_Compare */
    UT_SC_StartAtsRq_CompareHookRunCount = 0;
    Ut_CFE_TIME_SetFunctionHook(UT_CFE_TIME_COMPARE_INDEX,
                                &UT_SC_StartAtsRq_CompareHook3);
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_ATS_SERVICE_SWTCH_INF_EID, CFE_EVS_INFORMATION,
...
void SC_ServiceSwitchPend_Test_AtsEmpty(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      SC_SERVICE_SWITCH_ATS_CMD_LDED_ERR_EID, CFE_EVS_ERROR,
...
void SC_ServiceSwitchPend_Test_AtpIdle(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_ATS_SERVICE_SWITCH_IDLE_ERR_EID, CFE_EVS_ERROR,
                             "Switch ATS Rejected: ATP is idle"),
        "Switch ATS Rejected: ATP is idle");
...
void SC_InlineSwitch_Test_Nominal(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_ATS_INLINE_SWTCH_INF_EID, CFE_EVS_INFORMATION,
                             "ATS Switched from A to B"),
        "ATS Switched from A to B");
...
void SC_InlineSwitch_Test_AllCommandsSkipped(void) {
    ...
    /* Set to cause all commnds to be skipped, to reach block starting with
     * comment "all of the commands in the new ats were skipped" */
    Ut_CFE_TIME_SetFunctionHook(UT_CFE_TIME_COMPARE_INDEX,
                                &UT_SC_StartAtsRq_CompareHookAgreaterthanB);
...
void SC_InlineSwitch_Test_DestinationAtsNotLoaded(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      SC_ATS_INLINE_SWTCH_NOT_LDED_ERR_EID, CFE_EVS_ERROR,
                      "Switch ATS Failure: Destination ATS Not Loaded"),
                  "Switch ATS Failure: Destination ATS Not Loaded");
...
void SC_JumpAtsCmd_Test_SkipOneCmd(void) {
    ...
    UtAssert_True(SC_OperData.AtsCtrlBlckAddr->CmdNumber ==
                  ...
                  "SC_OperData.AtsCtrlBlckAddr->CmdNumber == "
                  "SC_AppData.AtsTimeIndexBuffer[AtsIndex][0]");
    UtAssert_True(SC_OperData.AtsCtrlBlckAddr->TimeIndexPtr == 1,
                  "SC_OperData.AtsCtrlBlckAddr->TimeIndexPtr == 1");
    UtAssert_True(SC_AppData.NextCmdTime[0] == 0,
                  "SC_AppData.NextCmdTime[0] == 0");
    UtAssert_True(SC_AppData.CmdCtr == 1, "SC_AppData.CmdCtr == 1");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_JUMP_ATS_INF_EID, CFE_EVS_INFORMATION,
                             "Next ATS command time in the ATP was set to "
                             "1980-001-00:00:00.00000"),
        "Next ATS command time in the ATP was set to 1980-001-00:00:00.00000");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_JUMP_ATS_SKIPPED_DBG_EID, CFE_EVS_DEBUG,
...
void SC_JumpAtsCmd_Test_AllCommandsSkipped(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      SC_JUMPATS_CMD_STOPPED_ERR_EID, CFE_EVS_ERROR,
...
void SC_JumpAtsCmd_Test_NoRunningAts(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_JUMPATS_CMD_NOT_ACT_ERR_EID, CFE_EVS_ERROR,
...
void ContinueAtsOnFailureCmd_Test_Nominal(void) {
    ...
    CFE_SB_InitMsg(&CmdPacket, SC_CMD_MID,
                   sizeof(SC_SetContinueAtsOnFailureCmd_t), TRUE);
    ...
    /* Verify results */
    UtAssert_True(SC_AppData.ContinueAtsOnFailureFlag == TRUE,
                  "SC_AppData.ContinueAtsOnFailureFlag == TRUE");
    UtAssert_True(SC_AppData.CmdCtr == 1, "SC_AppData.CmdCtr == 1");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(SC_CONT_CMD_DEB_EID, CFE_EVS_DEBUG,
...
void ContinueAtsOnFailureCmd_Test_InvalidState(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            SC_CONT_CMD_ERR_EID, CFE_EVS_ERROR,
...
void SC_AppendAtsCmd_Test_InvalidAtsId(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(SC_APPEND_CMD_ARG_ERR_EID, CFE_EVS_ERROR,
...
void SC_AppendAtsCmd_Test_NoRoomForAppendInAts(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(SC_APPEND_CMD_FIT_ERR_EID, CFE_EVS_ERROR,
                                       "Append ATS A error: ATS size = 8000, "
                                       "Append size = 8000, ATS buffer = 8000"),
                  "Append ATS A error: ATS size = 8000, Append size = 8000, "
                  "ATS buffer = 8000");
...
void SC_Atsrq_Test_AddTestCases(void) {
    UtTest_Add(SC_StartAtsCmd_Test_Nominal, SC_Test_Setup, SC_Test_TearDown,
               "SC_StartAtsCmd_Test_Nominal");
    UtTest_Add(SC_StartAtsCmd_Test_CouldNotStart, SC_Test_Setup,
               SC_Test_TearDown, "SC_StartAtsCmd_Test_CouldNotStart");
    UtTest_Add(SC_StartAtsCmd_Test_NoCommands, SC_Test_Setup, SC_Test_TearDown,
               "SC_StartAtsCmd_Test_NoCommands");
    UtTest_Add(SC_StartAtsCmd_Test_InUse, SC_Test_Setup, SC_Test_TearDown,
               "SC_StartAtsCmd_Test_InUse");
    UtTest_Add(SC_StartAtsCmd_Test_InvalidAtsId, SC_Test_Setup,
               SC_Test_TearDown, "SC_StartAtsCmd_Test_InvalidAtsId");
    UtTest_Add(SC_StopAtsCmd_Test_NominalA, SC_Test_Setup, SC_Test_TearDown,
               "SC_StopAtsCmd_Test_NominalA");
    UtTest_Add(SC_StopAtsCmd_Test_NominalB, SC_Test_Setup, SC_Test_TearDown,
               "SC_StopAtsCmd_Test_NominalB");
    UtTest_Add(SC_StopAtsCmd_Test_NoRunningAts, SC_Test_Setup, SC_Test_TearDown,
               "SC_StopAtsCmd_Test_NoRunningAts");
    UtTest_Add(SC_BeginAts_Test_Nominal, SC_Test_Setup, SC_Test_TearDown,
               "SC_BeginAts_Test_Nominal");
    UtTest_Add(SC_BeginAts_Test_AllCommandsSkipped, SC_Test_Setup,
               SC_Test_TearDown, "SC_BeginAts_Test_AllCommandsSkipped");
    UtTest_Add(SC_KillAts_Test, SC_Test_Setup, SC_Test_TearDown,
               "SC_KillAts_Test");
    UtTest_Add(SC_GroundSwitchCmd_Test_Nominal, SC_Test_Setup, SC_Test_TearDown,
               "SC_GroundSwitchCmd_Test_Nominal");
    UtTest_Add(SC_GroundSwitchCmd_Test_DestinationAtsNotLoaded, SC_Test_Setup,
               SC_Test_TearDown,
               "SC_GroundSwitchCmd_Test_DestinationAtsNotLoaded");
    UtTest_Add(SC_GroundSwitchCmd_Test_AtpIdle, SC_Test_Setup, SC_Test_TearDown,
               "SC_GroundSwitchCmd_Test_AtpIdle");
    UtTest_Add(SC_ServiceSwitchPend_Test_Nominal, SC_Test_Setup,
               SC_Test_TearDown, "SC_ServiceSwitchPend_Test_Nominal");
    UtTest_Add(SC_ServiceSwitchPend_Test_AtsEmpty, SC_Test_Setup,
               SC_Test_TearDown, "SC_ServiceSwitchPend_Test_AtsEmpty");
    UtTest_Add(SC_ServiceSwitchPend_Test_AtpIdle, SC_Test_Setup,
               SC_Test_TearDown, "SC_ServiceSwitchPend_Test_AtpIdle");
    UtTest_Add(SC_InlineSwitch_Test_Nominal, SC_Test_Setup, SC_Test_TearDown,
               "SC_InlineSwitch_Test_Nominal");
    UtTest_Add(SC_InlineSwitch_Test_AllCommandsSkipped, SC_Test_Setup,
               SC_Test_TearDown, "SC_InlineSwitch_Test_AllCommandsSkipped");
    UtTest_Add(SC_InlineSwitch_Test_DestinationAtsNotLoaded, SC_Test_Setup,
               SC_Test_TearDown,
               "SC_InlineSwitch_Test_DestinationAtsNotLoaded");
    UtTest_Add(SC_JumpAtsCmd_Test_SkipOneCmd, SC_Test_Setup, SC_Test_TearDown,
               "SC_JumpAtsCmd_Test_SkipOneCmd");
    UtTest_Add(SC_JumpAtsCmd_Test_AllCommandsSkipped, SC_Test_Setup,
               SC_Test_TearDown, "SC_JumpAtsCmd_Test_AllCommandsSkipped");
    UtTest_Add(SC_JumpAtsCmd_Test_NoRunningAts, SC_Test_Setup, SC_Test_TearDown,
               "SC_JumpAtsCmd_Test_NoRunningAts");
    UtTest_Add(ContinueAtsOnFailureCmd_Test_Nominal, SC_Test_Setup,
               SC_Test_TearDown, "ContinueAtsOnFailureCmd_Test_Nominal");
    UtTest_Add(ContinueAtsOnFailureCmd_Test_InvalidState, SC_Test_Setup,
               SC_Test_TearDown, "ContinueAtsOnFailureCmd_Test_InvalidState");
    UtTest_Add(SC_AppendAtsCmd_Test_Nominal, SC_Test_Setup, SC_Test_TearDown,
               "SC_AppendAtsCmd_Test_Nominal");
    UtTest_Add(SC_AppendAtsCmd_Test_InvalidAtsId, SC_Test_Setup,
               SC_Test_TearDown, "SC_AppendAtsCmd_Test_InvalidAtsId");
    UtTest_Add(SC_AppendAtsCmd_Test_AtsTableEmpty, SC_Test_Setup,
               SC_Test_TearDown, "SC_AppendAtsCmd_Test_AtsTableEmpty");
    UtTest_Add(SC_AppendAtsCmd_Test_AppendTableEmpty, SC_Test_Setup,
               SC_Test_TearDown, "SC_AppendAtsCmd_Test_AppendTableEmpty");
    UtTest_Add(SC_AppendAtsCmd_Test_NoRoomForAppendInAts, SC_Test_Setup,
               SC_Test_TearDown, "SC_AppendAtsCmd_Test_NoRoomForAppendInAts");
